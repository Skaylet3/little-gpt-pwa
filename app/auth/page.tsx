...
function GoogleSignInButton({ onClick, disabled }: GoogleSignInButtonProps) {
  return (
    <Button
      ...
      disabled={disabled}
      className={cn(
        "py-[16px] w-full rounded-full gap-[8px]",
...
export function PageFooter() {
  return (
    <footer className="sticky bottom-0 pb-6 text-center">
      <p className="text-xs text-gray-400">
        © 2025 Little GPT. Built to help, designed for people.
      </p>
    </footer>
  );
}
